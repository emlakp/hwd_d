...
class ContextRSSMCore(nn.Module):
    ...
    def forward(
        ...
        for t in range(time_steps):
            ...
            (context, h, posterior_sample), gates = self.cell(
                actions[t], (h, z, context), reset_masks[t], embeds[t], temperature=temperature
            )
        ...
        final_state = (h.detach(), z.detach(), context.detach())
